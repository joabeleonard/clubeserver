...
public class ClientController {
	...
	@RequestMapping(value = "/apolice", method = RequestMethod.GET, produces = MediaType.APPLICATION_PDF_VALUE)
	public ResponseEntity<Resource> citiesReport(@CurrentUser UserPrincipal currentUser)
			 {
